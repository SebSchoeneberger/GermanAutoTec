  ...
  return (
    <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-[#1C262D]">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Premium Mercedes vehicle - German AutoTec specializes in Mercedes care and detailing in Addis Ababa"
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            >
              Professional care
              <br />
              <span className="text-gradient-hero">for your Mercedes.</span>
            </motion.h1>
            <motion.p variants={item} className="text-base sm:text-lg lg:text-xl text-gray-300 max-w-xl mx-auto lg:mx-0">
            Everything your Car needs: maintenance, repairs, diagnostics, and detailing all in one trusted place.            </motion.p>
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-3 sm:gap-4 max-w-md mx-auto lg:mx-0 w-full">
            ...
            <a href="#services" className="block">
              ...
              >
                <span className="text-3xl sm:text-4xl font-bold text-white">Garage</span>
                <span className="text-sm text-gray-400 mt-1">Mercedes only</span>
              </motion.div>
            </a>
            <a href="#services" className="block">
              <motion.div
                ...
                className="rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-4 sm:p-5 flex flex-col justify-center hover:bg-white/10 hover:border-white/20 transition-colors cursor-pointer"
              >
                <span className="text-3xl sm:text-4xl font-bold text-white">Detailing</span>
                <span className="text-sm text-gray-400 mt-1">All brands</span>
              </motion.div>
            </a>
          </div>
